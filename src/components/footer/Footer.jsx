...
const Footer = () => {
  return (
    <footer className='bg-[#244D3F] py-5'>
      ...
      <h3 className='text-[20px] md:text-2xl font-semibold'>Social Links</h3>
      ...
      <div className='grid grid-cols-1 space-y-2 justify-between md:flex items-center justify-between mt-3 text-gray-400'>
